classdef lathe
    ...
    properties % SPINDLE SHAFT BEARINGS
        ...
        spindleMisalignAngleX = deg2rad(-0.03); %[Rad]
        spindleMisalignAngleY = deg2rad(0.03); %[Rad]
        spindleBearingRunout = 0.0013*25.4; %[mm]
    ...
    properties % RAIL SYSTEM
        ...
        d6 = 0.75*25.4; % [mm] Rail diameter
        E6 = 200E3; %[MPa] Modulus of Elasticity of Steel
        railEndTreatment = 'pin-pin';
        railStraightness = (0.002)/(12); % [mm/mm] Straightness {McMaster}
        ...
        railMisalignAngleX = (0.001*25.4)/220; %[rad] % Axis misalignment about x-axis
        railMisalignAngleY = (-0.001*25.4)/220; %[rad] % Axis misalignment about y-axis
        rail2MisalignAngleX = (0.001*25.4)/220; %[rad] % Axis misalignment about x-axis (Rail with Flexure)
    end
    ...
    properties
        ...
        xFeedMisalignmentX = deg2rad(-0.1); % [rad] Misalignment aboux x-axis
        xFeedMisalignmentY = deg2rad(0.04); % [rad] Misalignment aboux y-axis
        xFeedMisalignmentZ = deg2rad(0.04);% [rad] Misalignment aboux z-axis
